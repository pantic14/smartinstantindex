...
def _make_http_from_dict(credentials_dict: dict):
...
def fetch_indexed_pages_from_dict(site_url: str, credentials_dict: dict, months_back: int = 16) -> set:
    """Variant that accepts credentials as a dict instead of a file path (for cloud use)."""
    http = _make_http_from_dict(credentials_dict)
